...
ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = price, y = carat), color = "blue")
...
ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = price, y = carat, shape = cut), color = "blue")

# Draw a scatter plot for `diamonds.sample` of *`cut`* by `carat`, where each
# point has an aesthetic _size_ based on the diamond's *`price`*


ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = cut, y = carat, size = price), color = "blue")
...
ggplot(data = diamonds.sample) + geom_bar(mapping = aes(x = cut, color = carat))
...
ggplot(data = diamonds.sample, mapping = aes(x = price, fill = clarity)) + stat_bin()
